...
export function PostPill({ post, onClick }: { post: Post, onClick: () => void }) {
  const statusClasses = {
    draft: 'bg-yellow-400/20 text-yellow-700 border-yellow-400/50 hover:bg-yellow-400/30',
    ready: 'bg-blue-400/20 text-blue-700 border-blue-400/50 hover:bg-blue-400/30',
    published: 'bg-gray-400/20 text-gray-600 border-gray-400/50 hover:bg-gray-400/30',
  };
